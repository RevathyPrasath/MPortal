...
angular.module('healthCareApp')
  .controller('PersonCtrl', function($scope, $rootScope, ApiService, healthCareBusinessConstants, $location, $window) {
    ...
    vm.active = function() {
      return vm.pageNo == 1 && vm.pageNo <= 5; //5 is considered as the last page
    };
    ...
    vm.getPersonals = function() {
      ApiService.get(healthCareBusinessConstants.PERSONAL).then(getPersonalsSb, errorCallback).finally(finalCallBack);
    };
